-- CreateEnum
CREATE TYPE "WisataKategori" AS ENUM ('WISATA_ALAM', 'KULINER', 'BUDAYA');

-- CreateEnum
CREATE TYPE "ChartType" AS ENUM ('BAR_CHART', 'LINE_CHART', 'PIE_CHART', 'DOUGHNUT_CHART', 'AREA_CHART', 'STAT_CARDS');
...
CREATE TABLE "wisata" (
    ...
    "kategori" "WisataKategori" NOT NULL,
    "gambar" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "infografis" (
    ...
    "chartType" "ChartType" NOT NULL DEFAULT 'BAR_CHART',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
